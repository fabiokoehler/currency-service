package br.koehler.currencyconversionservice;
...
public class CurrencyConversionController {
    ...
    @GetMapping("/currency-exchange-template/from/{from}/to/{to}/quantity/{quantity}")
    public CurrencyConversionBean convertCurrencyTemplate(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
